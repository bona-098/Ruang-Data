...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $unit_kerja = [
            ...
            [
                'nama' => 'Marketing, Sales & Solution',
            ],
            [
                'nama' => 'Planning & Delivery ',
            ],
            [
                'nama' => 'Operation & Maintenance',
            ],
            [
                'nama' => 'Business Support & Risk Management
',
            ],
            [
                'nama' => 'Area Kaltimtara',
            ],
            [
                'nama' => 'Area Kalselteng',
            ],
            [
                'nama' => 'Area Kalbar',
            ],
