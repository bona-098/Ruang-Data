                        ...
                        <tbody>
                            @foreach ($monitoringpm as $m)
                                <tr>
                                    ...
                                    <div class="modal fade" id="detail-{{ $m->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body ">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="nilai_perbulan"
                                                                            ...
                                                                            name="nilai_perbulan" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row p-t-20">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select id="jenis_pengelolaan"
                                                                            name="jenis_pengelolaan" class="form-control">
                                                                            <option value="Direct"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select id="mitra_pengelolaan"
                                                                            name="mitra_pengelolaan" class="form-control">
                                                                            ...
                                                                            <option value="PT Sinergi Integral Manunggal"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $m->jumlah_hk }}" name="jumlah_hk"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            name="jumlah_security" class="form-control"
                                                                            oninput="hitungTotalPKWTUpdate({{ $m->id }})">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            name="total_pkwt_update" class="form-control"
                                                                            readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="control-label">CRM / NO
                                                                            PID</label>
                                                                        <input value="{{ $m->crm_np }}" type="text"
                                                                            id="crm_np" name="crm_np"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- Delete Form -->
                                                    <form id="deleteForm"
                                                        action="{{ route('monitoringpm.destroy', $m->id) }}"
