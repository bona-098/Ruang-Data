                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="portfolio" class="form-control custom-select">
                                                    ...
                                                    <option value="TRANSPORT MANAGEMENT SERVICES">TRANSPORT MANAGEMENT
                                                        SERVICES
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="nilai_total_project" type="number" class="form-control">
                                                <small class="form-control-feedback">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="nilai_project_pertahun" type="text" class="form-control">
                                                <small class="form-control-feedback">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="nilai_project_perbulan" type="text" class="form-control">
                                                <small class="form-control-feedback">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="nama_key_kontak_client" type="text" class="form-control">
                                                <small class="form-control-feedback">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="jabatan_pic_client" type="text" class="form-control">
                                                <small class="form-control-feedback">
