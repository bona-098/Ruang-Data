        ...
        <div class="col-lg-12">
            <div class="card card-outline-primary">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Edit Data Sales</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="firstName" value="{{ $sales->unit_kerja }}" class="form-control" name="nik">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Status Revenue</label>
                                        <input type="text" id="firstName" value="{{ $sales->status_revenue }}" class="form-control" name="nik">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Customer</label>
                                        <input type="text" id="firstName" value="{{ $sales->customer }}" class="form-control" name="nik">
                                    </div>
                                </div>
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Tanggal Lahir</label>
                                        <input type="date" class="form-control" value="{{ $sales->tgl_mulai_project }}">
                                    </div>
                                </div> --}}
                            </div>
                            <div class="row">
