                                ...
                                @foreach ($jobHistories as $job)
                                    <tr>
                                        <td>
                                            <div class="round-img">
                                                <a href="">
                                                    <img src="{{ asset('storage/foto/' . ($job->karyawan->foto ?? 'default.jpg')) }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </td>
                                        <td style="text-align: center; vertical-align: middle;">
                                            @if ($job->karyawan)
                                                @if ($job->karyawan->datakerjakaryawans->isNotEmpty())
                                                    {{ $job->karyawan->datakerjakaryawans->first()->nik }} /
                                                    {{ $job->karyawan->datakerjakaryawans->first()->telkomgroup }}
                                                @else
                                                    N/A
                                                @endif
                                            @else
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            @if ($job->karyawan && $job->karyawan->datakerjakaryawans->isNotEmpty())
                                                {{ $job->karyawan->datakerjakaryawans->first()->unit_kerja }}
                                            @else
                                                N/A
                                            @endif
                                        </td>
