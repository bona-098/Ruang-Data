...
<head>
    ...
    <link href="template/template/css/lib/calendar2/semantic.ui.min.css" rel="stylesheet">
...
<body class="fix-header fix-sidebar">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="template/images/users/5.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="template/template/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="template/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="template/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="template/images/users/5.jpg" alt="user" class="profile-pic" /></a>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="template/images/avatar/4.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="template/images/avatar/2.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="template/images/avatar/3.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
    ...
    <!-- Amchart -->
     <script src="template/js/lib/morris-chart/raphael-min.js"></script>
    <script src="template/template/js/lib/morris-chart/morris.js"></script>
    <script src="template/js/lib/morris-chart/dashboard1-init.js"></script>


	<script src="template/js/lib/calendar-2/moment.latest.min.js"></script>
    <!-- scripit init-->
    <script src="template/js/lib/calendar-2/semantic.ui.min.js"></script>
    <!-- scripit init-->
    <script src="template/js/lib/calendar-2/prism.min.js"></script>
    <!-- scripit init-->
